							...
							<div class="block-web">
								<div class="porlets-content">
									<form:form class="form-horizontal row-border" id="formulario"
										method="post" commandName="manualjobForm"
										action="addManualJob">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<form:input path="description" class="form-control"
													...
													required="required"
													oninvalid="setCustomValidity('Ingresa una descripción de no mas de 50 caracteres (no usar / y ,))"
													oninput="setCustomValidity('')" />
											</div>
										</div>
										<!--/form-group-->
										<div class="form-group">
											...
											<div class="col-sm-9">
												<form:input path="finalPrice" class="form-control"
													type="number" step="any" min="1" required="required"
