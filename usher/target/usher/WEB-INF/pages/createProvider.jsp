...
<li><a href="stats1">INFORMES</a></li>  
    ...
    <div class="page-content">
        ...
        <div class="col-md-6">
          <div class="block-web">
           <form:form class="form-horizontal row-border" id="formulario" method="post" commandName="providerForm" action="addProvider">
            ...
            <div class="porlets-content">
				...
				<div class="form-group">       
                  ...
                  <form:input path="company" class="form-control"
						type="text"  
						pattern="^([a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ'\-\_\.\,\/]{1,45}[\s]*)+"
						required="required" 
