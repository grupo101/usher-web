            ...
            <div class="table-responsive">
 			...
 			<thead>
				<tr>
					...
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column ascending" style="width: 177px;">Tipo Factura</th>
...
<div class="block-web">
		...
		<table style="width: 100%;" class="dataTables_wrapper form-inline" aria-describedby="dynamic-table_info">
			...
			<th align=left style="background-color: #f6f6f6">Empresa:</th>
				...
				<th style="background-color: white"><form:input id="cuit"
						...
						oninvalid="setCustomValidity('Ingresa por lo menos 8 dígitos, con un máximo de 11')" 
                   		oninput="setCustomValidity('')"/></th>			
				<th align=left style="background-color: #f6f6f6">Tipo Factura:</th>
				<th style="background-color: white"><form:input id="invoiceType"
						path="invoiceType" 
						type="text"
						pattern="[A-D]{1}"
						required="required" 
			...
			<tr>
				...
				<th style="background-color: white"><form:input id="phoneNumber1"
						...
						oninvalid="setCustomValidity('Ingresa solo numeros')" 
                   		oninput="setCustomValidity('')" /></th>                   		
                <th align=left style="background-color: #f6f6f6">Email:</th>
			...
			<th align=left style="background-color: #f6f6f6">Fecha alta:</th>
				<th style="background-color: white"><form:input id="dateUp"
						path="dateUp" readonly="false"/></th>											
				<th align=center style="weight: 100%; background-color: #f6f6f6">Deuda:</th>
					<th style="background-color: white"><form:input id="debt"
						path="debt" readonly="false" /></th>			
	...
	<hr />		
	<a href="client"><input class="btn btn-primary btn-lg" id="registrar" type="button" value="Registrar cliente" style="width: 100%;"></a> 	
	<hr />
...
<div class="demo">  </div>
	...
	<script type="text/javascript">
		function getCellsValue(cell) {
			...
			document.getElementById('invoiceType').value = tags_td.item(5).innerHTML;
			document.getElementById('adress').value = tags_td.item(6).innerHTML;
			document.getElementById('locality').value = tags_td.item(7).innerHTML;
			document.getElementById('province').value = tags_td.item(8).innerHTML;
			document.getElementById('phoneNumber1').value = tags_td.item(9).innerHTML;
			document.getElementById('phoneNumber2').value = tags_td.item(10).innerHTML;
			document.getElementById('eMail').value = tags_td.item(11).innerHTML;
			document.getElementById('dateUp').value = tags_td.item(12).innerHTML;			
			document.getElementById('debt').value = tags_td.item(13).innerHTML;
	...
	<script type="text/javascript">
		function pickModifyButton() {
			if(document.getElementById('id').value == 0){
				alert("Debe seleccionar un cliente para modificarlo");
				return false;
			}
			document.getElementById('form1').action = "modifyClient";
			//document.getElementById('form1').submit();
		}
		function pickRemoveButton() {
			document.getElementById('form1').action = "removeClient";
			//document.getElementById('form1').submit();
		}
	</script>
</html>
