...
<li><a href="stats1">INFORMES</a></li>  
        ...
        <div class="col-md-12">
         ...
         <div class="porlets-content">
        	...
        	<tbody>
	            ...
	            <tr>
	                <td>${purchase.id}</td>
	                <td style="display:none">${purchase.provider}</td>
	                <td>${purchase.providerCompany}</td>
	                <td>${purchase.providerCuit}</td>
	...
	<p>
		<b>COMPRA SELECCIONADA:</b>
	</p>

<div class="block-web">
	<form:form id="form1" name="form1" method="post"
		commandName="purchaseForm" action="">
	
		<table style="width: 100%;" class="dataTables_wrapper form-inline" aria-describedby="dynamic-table_info">

			<tr>
				<th align=left style="background-color: #f6f6f6">Nro. de compra:</th>
				<th style="background-color: white"><form:input id="id"	path="id" readonly="true"/></th>
				<th style="display:none"><form:input id="provider"	path="provider" readonly="true"/></th>
				<th align=left style="background-color: #f6f6f6">Precio total:</th>
				<th style="background-color: white"><form:input id="totalPrice"
						path="totalPrice" readonly="true"/></th>
			</tr>
			<tr>
				<th align=left style="background-color: #f6f6f6">Empresa:</th>
				<th style="background-color: white"><form:input id="providerCompany" path="providerCompany" readonly="true"/></th>
				<th align=left style="background-color: #f6f6f6">Cuit:</th>
				<th style="background-color: white"><form:input id="providerCuit" path="providerCuit" readonly="true"/></th>
				

			</tr>
			<tr>
			<th align=left style="background-color: #f6f6f6">fecha de compra:</th>
				<th style="background-color: white"><form:input id="datePurchase"
						path="datePurchase" readonly="true"/></th>
						<th style="background-color: white"></th>	
						<th style="background-color: white"></th>	
			</tr>
			<tr>
				<th align=char style="background-color: white"></th>
				<th style="background-color: white"></th>	
				<th align=center style="weight: 100%; background-color: white"></th>
				<th align=center style="background-color: white;width:10%"> 
					<input id="consultButton" disabled class="btn btn-primary btn-sm" style="width: 48%;" type="button" name="Consultar" value="Consultar" onclick="pickModifyButton()">
					<input id="removeButton" disabled class="btn btn-primary btn-sm" style="width: 49%;" type="button" name="Eliminar" value="Eliminar" onclick="pickRemoveButton()"></th>
				</tr>
		</table>
		</form:form>
		</div>
...
function getCellsValue(cell) {
	...
	document.getElementById('provider').value = tags_td.item(1).innerHTML;
	document.getElementById('providerCompany').value = tags_td.item(2).innerHTML;
	document.getElementById('providerCuit').value = tags_td.item(3).innerHTML;
	document.getElementById('totalPrice').value = tags_td.item(4).innerHTML;
	document.getElementById('datePurchase').value = tags_td.item(5).innerHTML;
...
function pickModifyButton() {
	document.getElementById('form1').action = "checkPurchaseToProvider";
	document.getElementById('form1').submit();
}
function pickRemoveButton() {
	document.getElementById('form1').action = "deletePurchase";
	document.getElementById('form1').submit();
}
</script>
