...
<li><a href="stats1">INFORMES</a></li>  
	...
	<p>
		<b>VENTA SELECCIONADA:</b>
	</p>

<div class="block-web">
	<form:form id="form1" name="form1" method="post"
		commandName="saleForm" action="">
	
		<table style="width: 100%;" class="dataTables_wrapper form-inline" aria-describedby="dynamic-table_info">
			<tr>
				<th align=left style="background-color: #f6f6f6">Nro. de venta:</th>
				<th style="background-color: white"><form:input id="id"
						path="id" readonly="true"/></th>
				<th align=left style="background-color: #f6f6f6">Id cliente:</th>
				<th style="background-color: white"><form:input id="client"
						path="client" readonly="true"/></th>
			...
			<tr>
				...
				<th style="background-color: white"><form:input id="clientName" path="clientName" readonly="true"/></th>
				<th align=left style="background-color: #f6f6f6">Cuit:</th>
				<th style="background-color: white"><form:input id="clientCuit"
					path="clientCuit" readonly="true"/></th>
				<th align=left style="background-color: #f6f6f6">fecha de venta:</th>
				<th style="background-color: white"><form:input id="dateSale"
						path="dateSale" readonly="true"/></th>
			...
			<tr>
				...
				<th align=center style="background-color: white;width:10%"> 
					<input id="consultButton" style="width: 48%;" class="btn btn-primary btn-sm" type="submit" name="Consultar" value="Consultar" onclick="pickModifyButton()" disabled>
...
function getCellsValue(cell) {
	...
	document.getElementById('client').value = tags_td.item(1).innerHTML;
	document.getElementById('clientName').value = tags_td.item(2).innerHTML;
	document.getElementById('clientCuit').value = tags_td.item(3).innerHTML;
	document.getElementById('dateSale').value = tags_td.item(5).innerHTML;
...
function pickModifyButton() {
	document.getElementById('form1').action = "checkInvoice";
	//document.getElementById('form1').submit();
}
function pickRemoveButton() {
	document.getElementById('form1').action = "deleteSale";
	//document.getElementById('form1').submit();
}
